...
import com.baotran.k22411csampleproject.SendSMSActivity;
import com.baotran.k22411csampleproject.TelephonyActivity;
...
public class TelephonyInforAdapter extends ArrayAdapter<TelephonyInfor> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ImageView imgDiaUp=item.findViewById(R.id.imgDiaUp);
        ...
        imgDiaUp.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
