...
public class AsyncTaskActivity extends AppCompatActivity {
    ...
    private void drawButtonRealtime() {
        ...
        //nếu ta gọi task.execute(n1,n2,n3); thì doInBackground nhận 1 mảng có 3 phần
    }
    ...
    class MyDrawButtonTask extends AsyncTask<Integer,Integer,Double>
    {
        ...
        protected Double doInBackground(Integer... integers) {
            ...
            for(int i=1;i<=n;i++)
            {
                ...
                //đẩy dữ liệu qua onProgessUpdate để vẽ giao diện thời gian thực:
                publishProgress(percent,value); //thứ tự truyền do ta quyết định
